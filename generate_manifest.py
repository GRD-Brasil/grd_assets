...
# Configurações
OMIT_FILES = {
    'generate_manifest.py', 'README.md', '.github', '.git', 'index.html', 'CNAME', 'manifest.json', 'site-src', 'node_modules', 'dist', 'convert_to_webp.py'
}
OMIT_DIRS = {
...
def main():
    parser = argparse.ArgumentParser(description="Gera manifest.json para o GRD Brasil Assets.")
